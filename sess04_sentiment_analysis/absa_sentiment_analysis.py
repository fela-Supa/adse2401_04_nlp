...
class ABSAAnalyser:
    def __init__(
        ...
        # pre compiler patterns: longest keywords first to avoid partial matches. example battery life must be checked before battery
    ...
    def analyze(self, text: str) -> SentenceResult:
        ...
        result.overall_label = self._label(result.overall_score or 0.0)
